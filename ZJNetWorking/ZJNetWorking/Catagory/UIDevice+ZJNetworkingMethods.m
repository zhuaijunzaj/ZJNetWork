//
//  UIDevice+ZJNetworkingMethods.m
//  ZJNetWorking
//
...
#import "UIDevice+ZJNetworkingMethods.h"
...
@implementation UIDevice (ZJNetworkingMethods)
- (NSString *) localMAC{
...
- (NSString *) ZJ_macaddressMD5{
    ...
    if (macid.length == 0) {
        NSString *macaddress = [[UIDevice currentDevice] ZJ_macaddress];
        macid = [macaddress ZJ_md5];
        if (!macid){
